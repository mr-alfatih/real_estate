...
class Property(models.Model):
    ...
    maintenance_request_count = fields.Integer(compute='_compute_maintenance_request_count', string="Maintenance Request Count")
    ...
    def create(self, vals):
        ...
        if vals.get("code", "New") == "New":
            ...
            # Create a product.template record first
            product_vals = {
                'name': vals.get('name', 'Unnamed Property'),
                'type': 'service',  # Example: setting the type to service
                # Add any other product.template fields here
            }
